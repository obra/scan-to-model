    ...
    try:
        ...
        return {
            ...
            "guard": {"present_in_depsgraph": evaluated.name in deps_names,
                       ...
                       "original_mesh_vertex_count": len(obj.data.vertices) if obj.type == "MESH" else None,
                       "original_mesh_polygon_count": len(obj.data.polygons) if obj.type == "MESH" else None,
                       "evaluated_mesh_vertex_count": len(mesh.vertices),
                       "evaluated_mesh_polygon_count": len(mesh.polygons),
