...
For source-photo review of model-space geometry, use `scripts/preview_geometry.py` with an accepted `raw_to_model4x4`; it emits provisional indexed wire overlays and projection records without manufacturing caps or hidden surfaces.
