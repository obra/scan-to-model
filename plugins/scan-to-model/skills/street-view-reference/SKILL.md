...
- An owner's wrong-building correction retires that target-identity claim. Record the correction, reidentify the intended facade and verify a new view; a plausible address or panorama ID does not override the correction. If the precise view at the correction was not recorded, say so rather than guessing which frame the owner meant. A panorama location and its current viewing direction can show different buildings.
